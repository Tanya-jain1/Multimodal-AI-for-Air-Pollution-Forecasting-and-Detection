...
from tensorflow.keras.layers import GRU, Dense, Dropout, Input  # <--- CHANGED HERE
...
# 2. LOAD DATA
# ==============================================================================
print("⏳ Loading Final Dataset for GRU...")
...
# 5. RESHAPE FOR GRU
# ==============================================================================
# GRU also needs 3D input: (Samples, TimeSteps, Features)
X_train_reshaped = X_train_scaled.reshape((X_train_scaled.shape[0], 1, X_train_scaled.shape[1]))
X_test_reshaped = X_test_scaled.reshape((X_test_scaled.shape[0], 1, X_test_scaled.shape[1]))

# ==============================================================================
# 6. BUILD MODEL (GRU VERSION)
# ==============================================================================
print("🧠 Building GRU Neural Network...")
model = Sequential()

# Input Layer + GRU Layer 1
# GRU is often faster to train than LSTM because it has fewer parameters
model.add(Input(shape=(1, X_train.shape[1])))
model.add(GRU(64, return_sequences=True)) # <--- GRU Layer
model.add(Dropout(0.2)) 

# GRU Layer 2
model.add(GRU(32, return_sequences=False)) # <--- GRU Layer
model.add(Dropout(0.2))
...
plt.plot(predictions_actual[:limit], label='GRU Prediction', color='green', linestyle='--') # Changed color to green
plt.title('Final GRU Model: Actual vs Predicted')
plt.xlabel('Hours')
...
# ==============================================================================
print("📊 Calculating GRU Training Metrics...")
...
print("-" * 40)
print(f"🏆 GRU TRAINING PERFORMANCE:")
...
# 1. Save the AI Brain
model.save('best_gru_model.keras') # <--- Changed Name
print("✅ Model saved as 'best_gru_model.keras'")

# 2. Save the Scalers 
# (These will overwrite the LSTM scalers if run in the same folder, 
# which is fine because the data/split is identical)
