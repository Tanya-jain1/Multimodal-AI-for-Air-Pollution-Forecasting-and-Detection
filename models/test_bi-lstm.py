...
from tensorflow.keras.layers import LSTM, Dense, Dropout, Input, Bidirectional # <--- CHANGED
...
# 2. LOAD DATA
# ==============================================================================
print("⏳ Loading Final Dataset for Bi-LSTM...")
...
# ==============================================================================
# 5. RESHAPE FOR Bi-LSTM
# ==============================================================================
# Same 3D shape required: (Samples, TimeSteps, Features)
X_train_reshaped = X_train_scaled.reshape((X_train_scaled.shape[0], 1, X_train_scaled.shape[1]))
X_test_reshaped = X_test_scaled.reshape((X_test_scaled.shape[0], 1, X_test_scaled.shape[1]))

# ==============================================================================
# 6. BUILD MODEL (Bi-LSTM VERSION)
# ==============================================================================
print("🧠 Building Bidirectional LSTM Neural Network...")
model = Sequential()
...
# Bi-LSTM Layer 1
# We wrap the LSTM layer inside Bidirectional()
...
# 7. TRAIN
# ==============================================================================
print("🚀 Training Bi-LSTM Started... (This is slightly slower than normal LSTM)")
history = model.fit(
...
# 8. PREDICT & VISUALIZE
# ==============================================================================
print("🔮 Forecasting with Bi-LSTM...")
...
plt.plot(predictions_actual[:limit], label='Bi-LSTM Prediction', color='purple', linestyle='--') # Purple for Bi-LSTM
plt.title('Final Bi-LSTM Model: Actual vs Predicted')
plt.xlabel('Hours')
...
# ==============================================================================
print("📊 Calculating Bi-LSTM Training Metrics...")
...
print("-" * 40)
print(f"🏆 Bi-LSTM TRAINING PERFORMANCE:")
...
# ==============================================================================
print("\n📊 Calculating Bi-LSTM TEST Metrics...")
...
# 1. Save the AI Brain
model.save('best_bilstm_model.keras') # <--- Changed Name
print("✅ Model saved as 'best_bilstm_model.keras'")

# 2. Save Scalers (Updates the same scaler files)
